...
const dump = JSON.parse(fs.readFileSync(path.join(ROOT, 'results', 'db-dump.json'), 'utf8'));
const engineCode = fs.readFileSync(path.join(ROOT, 'prediction-engine.js'), 'utf8');
